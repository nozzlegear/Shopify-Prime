...
describe("Webhooks", function () {
    this.timeout(30000);
    const service = new shopify_prime_1.Webhooks(config.shopDomain, config.accessToken);
    const toBeDeleted = [];
    ...
    it("should delete a webhook", () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield service.delete(webhook.id);
        }
        catch (e) {
            error = e;
        }
