...
function authorize(code, shopDomain, shopifyApiKey, shopifySecretKey) {
    return __awaiter(this, void 0, void 0, function* () {
        const service = new base_service_1.BaseService(shopDomain, undefined, "admin/oauth");
        const response = yield service.createRequest("POST", "access_token", "access_token", {
