 ...
 */
export declare function buildAuthorizationUrl(scopes: Enums.AuthScope[], shopifyDomain: string, shopifyApiKey: string, redirectUrl?: string, state?: string): Promise<string>;
/**
